...
def download_latest_build():
    ...
    url = "http://api.github.com/repos/aarron-lee/GpdControl/releases/latest"
    ...
    file_path = '/tmp/GpdControl.tar.gz'
...
def ota_update():
    ...
    cmd = f'echo {decky_plugin.DECKY_USER_HOME}/homebrew/plugins/GpdControl/ota_update.sh | HOME="{decky_plugin.DECKY_USER_HOME}" sh'
